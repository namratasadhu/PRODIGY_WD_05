...
btn.addEventListener("click",()=>{
    ...
    .then((data)=>{
        ...
        if (icon == "Haze") {
            document.querySelector(".icon").src="./images/clouds.jpg"
        }
            ...
            document.querySelector(".icon").src="./images/clear.jpg"
        }
        else if (icon == "Rain") {
            document.querySelector(".icon").src="./images/rain.jpg"
        }
        else if (icon == "Drizzle") {
            document.querySelector(".icon").src="./images/drizzle.jpg"
        }
        else if (icon == "Mist") {
            document.querySelector(".icon").src="./images/mist.jpg"
        }
        console.log(data)
    })
    .catch((error)=>{
